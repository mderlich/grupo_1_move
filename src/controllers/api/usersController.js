    ...
    users: async (req, res) => {
      ...
      usersDetails: async (req,res)=>{
          ...
          res.json({
            status:200,
            data:{
              ...singleUser.dataValues, //la promesa me devuelve un objeto del cual solo me interesa la propiedad dataValues
              urlImage: 'http://localhost:3000/images/users/' + singleUser.dataValues.image
            }
          });
