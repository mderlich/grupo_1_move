...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-09-2022 a las 20:35:46
...
(16, 6, 'Yucca', 'Las Zapatillas Topper Yucca se van a transformar en tu calzado más amigable una vez que las pruebes. Su capellada de textil tejida se adapta totalmente a la forma de tu pie para un andar más cómodo y flexible. La suela de EVA termoformada se integra fácilmente con la parte superior para que descubras el verdadero significado de la palabra confort.', 'zapatillas_topper_Yucca.jpg', 8999, 0, 'mujer', 'importado', 'https://www.moov.com.ar/zapatillas-topper-yucca/TO_52181.html');
...
(1, 'admin', 'admin', 'admin@move.com', '$2a$10$l8fTcHXgp5KUJ6enGYJqoepE9o91y225REqadDVU6gLoz7y6WwYSi', 'masc', '1662657523399_img.jpg', 'admin');
